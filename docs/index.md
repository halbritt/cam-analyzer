...
- [`rfc/0004-visualization-and-charts.md`](rfc/0004-visualization-and-charts.md) — an honest-by-construction chart suite: the static JSON projection and provenance/refusal grammar are implemented via `cam-analyze --charts json`, and a static valve-lift overlay SVG via `cam-analyze --charts svg`; ECharts, webapp, uncertainty bands, the P2V collision view, and the "go measure THIS" plan remain designed/deferred.
