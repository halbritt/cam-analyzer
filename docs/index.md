...
- [`rfc/0004-visualization-and-charts.md`](rfc/0004-visualization-and-charts.md) — an honest-by-construction chart suite: the static JSON projection, provenance/refusal grammar, threshold-duration table, heuristic confidence bands, quality warnings, and overlap-centered static SVAJ SVG are implemented via `cam-analyze --charts json|svg`; ECharts, webapp, calibrated uncertainty math, the P2V collision view, and the "go measure THIS" plan remain designed/deferred.
